...
class Application:
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            if len(predicts) > 0:
                self.bt1.config(text=predicts.pop(), font=("Courier", 20))
            ...
            if(len(predicts) > 1):
                ...
                self.bt2.config(text=predicts.pop(), font=("Courier", 20))
            ...
            if(len(predicts) > 2):
                ...
                self.bt3.config(text=predicts.pop(), font=("Courier", 20))
    ...
    def predict(self, test_image):
        ...
        result = self.loaded_model.predict(test_image.reshape(1, 200, 200, 1))


        # result_dru = self.loaded_model_dru.predict(test_image.reshape(1 , 200 , 200 , 1))

        # result_tkdi = self.loaded_model_tkdi.predict(test_image.reshape(1 , 200 , 200 , 1))

        # result_smn = self.loaded_model_smn.predict(test_image.reshape(1 , 200 , 200 , 1))
